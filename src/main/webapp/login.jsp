...
<body>
	<div style="width: 900px; height: 50px; position: absolute; text-align: center; left: 50%; top: 50%; margin-left: -450px;; margin-top: -280px;">
		<img src="${pageContext.request.contextPath }/images/" style="border-width: 0; margin-left: 0;" />
		<span style="float: center; margin-top: 35px; color: #488ED5;font-size: 20px">呼叫系统</span>
	</div>
	
	<div class="main-inner" id="mainCnt" style="width: 900px; height: 440px; overflow: hidden; position: absolute; left: 50%; top: 50%; margin-left: -450px; margin-top: -220px;
		 background-image: url('${pageContext.request.contextPath }/images/')">
		<div id="loginBlock" class="login" style="margin-top: 80px; height: 255px;">
			<div class="loginFunc">
				<div id="lbNormal" class="loginFuncMobile">员工登录</div>
			</div>
			<div class="loginForm">
				<form id="loginform" name="loginform" method="post" class="niceform" action="">
					...
					<div class="loginFormIpt loginFormIptWiotTh" style="margin-top:58px;">
						...
						<a href="${pageContext.request.contextPath}/rest/page/index" id="loginform:j_id19" name="loginform:j_id19">
	...
	<div style="width: 900px; height: 50px; position: absolute; text-align: left; left: 50%; top: 50%; margin-left: -450px;; margin-top: 220px;">
		<span style="color: #488ED5;">hf.cn</span>
		<span style="float: right; color: #488ED5;">自动外呼系统</span>
	</div>
</body>
</html>