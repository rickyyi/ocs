<%@page import="cn.hf.manage.util.Address"%>
...
<script type="text/javascript">
	...
	// 版权信息
	function showAbout(){
		$.messager.alert("呼叫系统 v1.0","设计: huafu<br/> 管理员邮箱: hf.cn <br/> QQ: 283393004");
	}
</script>
</head>
<body class="easyui-layout">
	<div data-options="region:'north',border:false"
		style="height:80px;padding:10px;background:url('./images/header_bg.png') no-repeat right;background-color: #e0ecff;">
		<div id="sessionInfoDiv"
			style="position: absolute;right: 5px;top:10px;">
			[<strong>超级管理员</strong>]，欢迎你！您使用[<strong><%=Address.getIp() %></strong>]IP登录！
		</div>
